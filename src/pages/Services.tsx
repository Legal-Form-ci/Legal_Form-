        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-20">
            ...
            <p className="text-center text-muted-foreground mb-8">
              Ces services sont liés à la création d'entreprise
            </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-8">
                <Card className="bg-white/10 backdrop-blur border-white/20">
                  <CardContent className="p-8">
                    ...
                    <div className="text-4xl font-bold text-accent mb-2">180 000 FCFA</div>
                    <p className="text-white/80">Création complète de votre entreprise</p>
                  </CardContent>
                </Card>
                <Card className="bg-white/10 backdrop-blur border-white/20">
                  <CardContent className="p-8">
                    <h3 className="font-heading font-bold text-2xl mb-2">Régions de l'intérieur</h3>
                    <div className="text-4xl font-bold text-accent mb-2">À partir de 150 000 FCFA</div>
                    <p className="text-white/80">Selon votre région</p>
                  </CardContent>
                </Card>
              </div>
              <div className="max-w-3xl mx-auto mb-6 bg-white/5 backdrop-blur rounded-xl p-6">
                <p className="text-lg text-white/90">
                  <strong>Ce tarif inclut :</strong> Rédaction de statuts, immatriculation RCCM, DFE, NCC, CNPS, IDU, NTD, Avis de constitution, Journal et DSV
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="border-2 hover:shadow-strong transition-all">
                ...
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm text-primary font-semibold">Sur devis</p>
                  <Link to="/service-request?service=structuration">
              ...
              <Card className="border-2 hover:shadow-strong transition-all">
                ...
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm text-primary font-semibold">Sur devis</p>
                  <Link to="/service-request?service=formation">
                    <Button className="w-full" size="sm">Soumettre ma demande</Button>
                  </Link>
                </CardContent>
              </Card>
              <Card className="border-2 hover:shadow-strong transition-all">
                ...
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm text-primary font-semibold">Sur devis</p>
                  <Link to="/service-request?service=financement">
                    <Button className="w-full" size="sm">Soumettre ma demande</Button>
                  </Link>
                </CardContent>
              </Card>
              <Card className="border-2 hover:shadow-strong transition-all">
                ...
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm text-primary font-semibold">Sur devis</p>
                  <Link to="/service-request?service=digitale">
                    <Button className="w-full" size="sm">Soumettre ma demande</Button>
                  </Link>
                </CardContent>
              </Card>
              <Card className="border-2 hover:shadow-strong transition-all">
                ...
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm text-primary font-semibold">Sur devis</p>
                  <Link to="/service-request?service=identite">
                    <Button className="w-full" size="sm">Soumettre ma demande</Button>
                  </Link>
                </CardContent>
              </Card>
              <Card className="border-2 hover:shadow-strong transition-all">
                ...
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm text-primary font-semibold">Sur devis</p>
                  <Link to="/service-request?service=comptabilite">
                    <Button className="w-full" size="sm">Soumettre ma demande</Button>
                  </Link>
                </CardContent>
              </Card>
